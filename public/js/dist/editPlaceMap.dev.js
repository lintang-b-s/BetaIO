...
var koordinat1 = document.getElementById('koor1');
var koordinat2 = document.getElementById('koor2');
var typekoord = document.getElementById("typecoord");
...
runPage(place.geometry.coordinates[1], place.geometry.coordinates[0]);
...
function monitorGeocoder(geocoder, marker) {
  geocoder.on('result', function (e) {
    ...
    koordinat1.setAttribute('value', "".concat(geoLng));
    koordinat2.setAttribute('value', "".concat(geoLat));
...
map.addControl(new mapboxgl.NavigationControl()); // const geolocate = new mapboxgl.GeolocateControl({
// positionOptions: {
// enableHighAccuracy: true
// },
...
function runPage(latitude, longitude) {
  ...
  koordinat1.setAttribute('value', "".concat(longitude));
  koordinat2.setAttribute('value', "".concat(latitude));
  typekoord.setAttribute('value', 'Point');
  ...
  function onDragEnd() {
    ...
    coordinates.innerHTML = "Longitude: ".concat(lngLat.lng, "<br />Latitude: ").concat(lngLat.lat); // koordinat1.innerHTML = `${lngLat.lng}`;
    // koordinat2.innerHTML = `${lngLat.lat}`

    koordinat1.setAttribute('value', "".concat(lngLat.lng));
    koordinat2.setAttribute('value', "".concat(lngLat.lat));
    typekoord.setAttribute('value', 'Point');
