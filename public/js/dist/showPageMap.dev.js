...
new mapboxgl.Marker().setLngLat(place.geometry.coordinates).setPopup(new mapboxgl.Popup({
  offset: 25
}).setHTML("<strong><h6>".concat(place.title, "</h6></strong>\n        <img class=\"img-fluid\" src=\"").concat(place.images[0].url, "\" alt=\"gambar place\">  </img>\n        <ul>\n          <li>type: ").concat(place.type, " </li>\n          <li>flora: ").concat(place.flora, " </li>\n          <li>fauna: ").concat(place.fauna, " </li>\n          <li>makanan: ").concat(place.makanan, " </li>\n          <li>habitant: ").concat(place.habitant, " </li>\n          <li id=\"air\">sumber air: ").concat(place.sumberAir, " </li>\n        </ul>\n       "))).addTo(map); // menacri rute terpendek dari 2 tempat
...
var directions = new MapboxDirections((_ref = {
  ...
  alternatives: false,
  geometries: 'geojson'
}, _defineProperty(_ref, "alternatives", true), _defineProperty(_ref, "controls", {
  instructions: false
}), _defineProperty(_ref, "flyTo", false), _ref));
...
map.on('load', function () {
  ...
  var startingLng = place.geometry.coordinates[0]; //On initial load set city name
  ...
  function runPage(latitude, longitude) {
    ...
    monitorGeocoder(); //https://docs.mapbox.com/mapbox-gl-js/example/drag-a-marker/
    // function onDragEnd(){
...
directions.on('route', function (event) {
  ...
  if (counter >= maxAttempts) {
    ...
    try {
      for (var _iterator = event.route[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
